...
In certain situations you must use a specialized workmu.
...
3. Figure out what algorithms are in use, how the data is structured and how it mus, reason about trade-offs taken.
